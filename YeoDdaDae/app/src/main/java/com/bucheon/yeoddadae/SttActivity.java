...
public class SttActivity extends AppCompatActivity {
        ...
        speechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onResults(Bundle results) {
                ...
                if (matches != null && matches.size() > 0) {
                    ...
                    // Update UI
                    sttContentTxt.setText(sttString);
                    statusTxt.setText("완료");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button sttBackBtn = (Button) findViewById(R.id.sttBackBtn);
        Button retryBtn = (Button) findViewById(R.id.retryBtn);
