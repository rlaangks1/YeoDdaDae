...
public class MainActivity_backup extends AppCompatActivity implements SttService.SttCallback {
    ...
    private SttService.SttCallback sttCallback = new SttService.SttCallback() {
        ...
        public void onMainCommandReceived(String mainCommand) {
            MainActivity_backup.this.onMainCommandReceived(mainCommand);
        }

        @Override
        public void onUpdateUI(String message) {
            MainActivity_backup.this.onUpdateUI(message);
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) { // 최초 실행인지 확인
            sd = new SttDialog(MainActivity_backup.this, new SttDialogListener() {
                @Override
